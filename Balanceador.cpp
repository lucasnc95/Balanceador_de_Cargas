...
void Balanceador::ComputarCargas(const long int *tempos, const float *cargasAntigas, float *cargas, int participantes)
{
	if(participantes == 1)
        {
                cargas[0] = 1.0f;
...
float Balanceador::ComputarDesvioPadraoPercentual(const long int *tempos, int participantes)
{
	double media = 0.0;
	for(int count = 0; count < participantes; count++)
	{
